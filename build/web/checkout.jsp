      ...
      <h2>Shipping Address</h2>
        <form action="payment.jsp" method="post">
          ...
          <div>
            ...
            <input type="text" name="email" id="email" value="" size="22" pattern="[0-9]{3}" required>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" name="email" id="email" value="" size="22" pattern="[0-9]{6}" title="Six digit zip code" required>
          </div>
