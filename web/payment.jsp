      ...
      <h2>Make Payment</h2>
        <form action="model/order.jsp" method="post" id="Form">
          ...
          <div class="half_width">
            ...
            <input type="text" name="name_credit_card" id="name_credit_card" size="22" style="width:300px;" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" required >
          </div>
		  <div class="half_width">
          ...
          <div>
            ...
            <input type="text" name="cvv" id="cvv" size="22" style="width:300px;" pattern="[0-9]{4}" required maxlength="4">
          </div>
          <div>
